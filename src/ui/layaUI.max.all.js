...
var niUI=(function(_super){
		function niUI(){
			

			niUI.__super.call(this);
		}

		CLASS$(niUI,'ui.niUI',_super);
		var __proto__=niUI.prototype;
		__proto__.createChildren=function(){
		    
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(niUI.uiView);
		}

		STATICATTR$(niUI,
		['uiView',function(){return this.uiView={"type":"View","props":{"width":600,"height":400},"child":[{"type":"Tab","props":{"y":180,"x":26,"selectedIndex":2},"child":[{"type":"Button","props":{"y":0,"x":0,"skin":"template/ButtonTab/btn_LargeTabButton_Left.png","name":"item0","labelSize":36,"labelColors":"#007AFF,#007AFF,#FFFFFF","label":"Button"}},{"type":"Button","props":{"y":0,"x":200,"skin":"template/ButtonTab/btn_LargeTabButton_Middle.png","name":"item1","labelSize":36,"labelColors":"#007AFF,#007AFF,#FFFFFF","label":"Button"}},{"type":"Button","props":{"y":0,"x":405,"skin":"template/ButtonTab/btn_LargeTabButton_Right.png","name":"item2","labelSize":36,"labelColors":"#007AFF,#007AFF,#FFFFFF","label":"Button"}}]}]};}
		]);
		return niUI;
	})(View);
